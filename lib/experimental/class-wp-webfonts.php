...
class WP_Webfonts extends WP_Dependencies {
	 ...
	 * @since 6.1.0
	 *
	 * @param string $font_family The font family for the variations.
	 ...
	 * @since 6.1.0
	 *
	 * @param string $font_family The registered font family to remove.
	 */
	public function remove_font_family( $font_family ) {
		$font_family_handle = sanitize_title( $font_family );
	 ...
	 */
	public function remove_variation( $font_family, $variation_handle ) {
		$font_family_handle = sanitize_title( $font_family );
	 ...
	 *
	 * @param string $font_family      The font family for this variation.
	 * @param array  $variation        The variation to add.
	 * @param string $variation_handle Optional. The variation's handle.
	 *                                 Default empty string.
	 */
	public function add_variation( $font_family, array $variation, $variation_handle = '' ) {
		$font_family_handle = sanitize_title( $font_family );
		...
		if ( '' === $variation_handle ) {
			$variation_handle = sanitize_title( implode( ' ', array( $variation['font-weight'], $variation['font-style'] ) ) );
		}
		...
		$this->add_dependency( $font_family, $variation_handle );
	 ...
	 *
	 * @param string $font_family   The font family for this variation.
	 * @param array  $variation     An array of variation arguments.
	 ...
	 * @return string[] Array of web font handles that have been processed.
	 */
	...
	/**
	 * Generates the @font-face ruleset styles for a provider.
	 *
	 * @since 6.1.0
	 *
	 ...
	 * @return bool
	 */
	public function do_item( $provider_id, $group = false ) {
